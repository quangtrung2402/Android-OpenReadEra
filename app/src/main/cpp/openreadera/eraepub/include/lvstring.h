...
public:
    ...
    static bool CharIsDvng(int ch);
    static bool CharIsBangla(int ch);

    static lString16 processDvngText(lString16 str);
    static lString16 processBanglaText(lString16 str);

    static void SwitchDvngI(lString16 *str);
    static void SwitchDvngI_reverse(lString16 *str);

    static void SwitchBanglaReph(lString16 *str);
    static void SwitchBanglaI(lString16 *str);
    static void SwitchBanglaE(lString16 *str);
    static void SwitchBanglaAI(lString16 *str);
    static void SwitchBanglaO(lString16 *str);
    static void SwitchBanglaOU(lString16 *str);
    static void SwitchBanglaRaITa(lString16 *str);
    static void StripZWNJ(lString16 *word);

    static void SwitchBanglaReph_reverse(lString16 *str);
    static void SwitchBanglaI_reverse(lString16 *str);
    static void SwitchBanglaE_reverse(lString16 *str);
    static void SwitchBanglaAI_reverse(lString16 *str);
    static void SwitchBanglaO_reverse(lString16 *str);
    static void SwitchBanglaOU_reverse(lString16 *str);
    static void SwitchBanglaRaITa_reverse(lString16 *str);
    static void StripZWNJ_reverse(lString16 *word);

    static void SwitchDvngReph_reverse(lString16 *str);
    static lString16 restoreIndicText(lString16 str);
