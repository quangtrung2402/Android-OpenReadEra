...
typedef std::map<lChar16 , dvngLig> BanglaLigMap;
typedef std::map<dvngLig , lChar16, Comparator> BanglaLigMapRev;
typedef std::map<lUInt32 , int> BanglaFastLigMap;

extern BanglaLigMap     gBanglaLigMap;
extern BanglaLigMapRev  gBanglaLigMapRev;
extern BanglaFastLigMap gBanglaFastLigMap;

BanglaLigMap GetBanglaLigMap();

BanglaLigMapRev BanglaLigMapReversed();
