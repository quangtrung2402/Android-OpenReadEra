...
void GetEpubMetadata(CrDom *dom, lString16 *res_title, lString16 *res_authors, lString16 *res_lang, lString16 *res_series, int *res_series_number, lString16 *res_genre, lString16 *res_annotation, int *fontcount);
