...
private:
    ...
    CssStyle OverwriteClass(CssStyle additional);


public:
    CssStyle() {};

    CssStyle(lString16 in);
    ...
    lString16 getBackground()  { return background_;}

    inline lString16 getStyleString() { return style_string_fonts;}
