...
/*
	fz_count_pixmap_luminosity: Calculate average pixel light level.
    Returns num from 0 to 255 where 0 is black and 255 is white

	Does not throw exceptions.
*/

//unsigned int fz_count_pixmap_luminosity(fz_pixmap *pix);

/*
	fz_count_pixmap_mode: Calculate whether image has main hue color
    Returns 0 (false) or 1(true)

	Does not throw exceptions.
*/

//unsigned int fz_count_pixmap_mode(fz_pixmap *pix);

/*
	fz_count_pixmap_needs_invert: Calculate whether image is grayscale
    Returns 0 (false) or 1(true)
