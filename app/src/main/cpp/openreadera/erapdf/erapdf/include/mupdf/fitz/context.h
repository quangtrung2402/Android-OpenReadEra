...
struct fz_context_s
{
	...
	// EraPDF: context flags
	int erapdf_nightmode;
	int erapdf_slowcmyk;
	int erapdf_ignore_most_errors;
	int erapdf_linearized_load;
	int erapdf_setcolor_per_page;
	int erapdf_file_stream_offset;
	int erapdf_has_password;
	int erapdf_reparing;
	int previewmode;
	int flag_interpolate_images;
	int preview_heavy_image;
    darkmode_obj_page *darkmode_objs;
	fz_rect ignore_rects[100];
	int ignore_rects_num;
};
