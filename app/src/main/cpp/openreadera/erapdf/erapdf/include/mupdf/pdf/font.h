...
// EraPDF: External font types >>>
enum { PDF_FD0_EXTERNAL, PDF_FD0_BUILTIN, PDF_FD0_SYSTEM };
// EraPDF: External font types <<<
...
// EraPDF: Load system font >>>
unsigned char *pdf_lookup_system_font(fz_context *ctx, const char *name, unsigned int *len);
// EraPDF: Load system font <<<
